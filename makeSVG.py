...
def createSVG(polygon, name):
    polygon_svg = makeSVG(polygon)
...
createSVG(hex_unit_1,'hex_unit_1.svg')
createSVG(hex_unit_2,'hex_unit_2.svg')
...
createSVG(hex_gen_1,'hex_gen_1.svg')
...
createSVG(hex_flex_1,'hex_flex_1.svg')
createSVG(hex_flex_2,'hex_flex_2.svg')
